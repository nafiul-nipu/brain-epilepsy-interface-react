...
export const EventViewer = ({ data, sliderObj, onEventsClicked }) => {
  if (!data) {
  ...
  function circleOnClick(values) {
    ...
    d3.select(`#play-pause-btn`).attr("value", "play").text("Play");
    ...
    <Col md="12" style={{ height: "95vh" }}>
      <svg width={width} height={height}>
        <g transform={`translate(${margin.left}, ${margin.top})`}>
          ...
          {/* creating left axis */}
          <AxisLeft xScale={xScale} yScale={yScale} scaleOffset={scaleOffset} />
