...
export const ElectrodeLoad = ({
    ...
    useLayoutEffect(() => {
        ...
        const currentSample = sampleData.communities;
        // console.log(currentSample)
        const coms = sampleData.communityList;
        console.log(coms)
    ...
    }, [allnetwork, eegInBrain, electrodeData, eventData, sampleData, seeRoi, selectedEventRange])
